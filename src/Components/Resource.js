          ...
          <div  className="cardMain1">
            <div className="cardResource">
              <div className="cardInnerLeft">
                <img style={{boxShadow: '10px 10px 4px rgba(0, 0, 0, 0.2)'}} src={cardImage} width="100%" height="250px"></img>
              </div>
              <div className="cardInnerRight" style={{boxShadow: '10px 10px 4px rgba(0, 0, 0, 0.2)'}}>
