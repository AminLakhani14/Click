                ...
                >
                    ...
                    >
                        <div className="" >
                            ...
                            <p className={window.innerWidth <= 540 ? "mobileparaforfeedback mb-0" : "feedbackpara col-8"} style={{ fontSize: window.innerWidth === 280 || window.innerWidth === 320 ? "17.5px" : " ", }}>The project aims to ensure the fulfillment of SDG (Sustainable Development Goal) 11, and “Sustainable Cities & Communities”,
                                and
                            ...
                            <p className={window.innerWidth <= 540 ? "mobileparaforfeedback mb-0" : "feedbackpara col-8"} style={{ fontSize: window.innerWidth === 280 || window.innerWidth === 320 ? "17.5px" : " ", }}>To improve urban management, service delivery and the business environment in Karachi.


                                The component is oriented towards improving the business environment of Karachi, as opposed to other activities, owing to complementarities between the activities in this and other components of the project. The Regulatory environment under which the private sector operates has a direct bearing on the other aspects of the investment climate, such as public infrastructure and public service delivery.

                                A more transparent, integrated, and streamlined Regulatory environment, therefore, would improve city competitiveness.

                                Increase the impact of public service delivery improvements on corresponding private sector investment and competitiveness.  </p>

                            {/* <p className={window.innerWidth <= 540 ? "mobileparaforfeedback mb-0" : "feedbackpara col-8"} style={{ fontSize: window.innerWidth === 280 || window.innerWidth === 320 ? "17.5px" : " ", }}>The component is oriented towards improving the business environment of Karachi, as opposed to other activities, owing to complementarities between the activities in this and other components of the project.
                            ...
                            <br />
                            <p className={window.innerWidth <= 540 ? "mobileparaforfeedback mb-0" : "feedbackpara col-8"} style={{ fontSize: window.innerWidth === 280 || window.innerWidth === 320 ? "17.5px" : " ", paddingLeft: window.innerWidth < 500 ? 0 : 40, }}><span style={{ fontWeight: "bold", }}>3.	CONDUCTING STUDY ON CONSTRAINTS FACED BY WOMEN BUSINESSES IN KARACHI  </span>
                                <br />
                            ...
                            <br />
                            <p className={window.innerWidth <= 540 ? "mobileparaforfeedback mb-0" : "feedbackpara col-8"} style={{ fontSize: window.innerWidth === 280 || window.innerWidth === 320 ? "17.5px" : " ", paddingLeft: window.innerWidth < 500 ? 0 : 40, }}><span style={{ fontWeight: "bold", }}>4.	CONDUCTING FEASIBILITY STUDY ON KARACHI INFRASTRUCTURE FUND </span>
                                <br />
                            ...
                            <br />
                            <p className={window.innerWidth <= 540 ? "mobileparaforfeedback mb-0" : "feedbackpara col-8"} style={{ fontSize: window.innerWidth === 280 || window.innerWidth === 320 ? "17.5px" : " ", paddingLeft: window.innerWidth < 500 ? 0 : 40, }}><span style={{ fontWeight: "bold", }}>5.	MARKETING OF COMPETITIVENESS AND IMPROVED REGULATORY ENVIRONMENT  </span>
                                <br />
                            ...
                            <p className={window.innerWidth <= 540 ? "mobileparaforfeedback mb-0" : "feedbackpara col-8"} style={{ fontSize: window.innerWidth === 280 || window.innerWidth === 320 ? "17.5px" : " ", }}>Recruitment of IT firm for the operationalization of the Sindh Business One Stop Shop( S-BOSS) </p>
                            <p className={window.innerWidth <= 540 ? "mobileparaforfeedback mb-0" : "feedbackpara col-8"} style={{ fontSize: window.innerWidth === 280 || window.innerWidth === 320 ? "17.5px" : " ", }}>Following Laws have been reviewed and draft legal changes/updates are underway. </p>
                            <p className={window.innerWidth <= 540 ? "mobileparaforfeedback mb-0" : "feedbackpara col-8"} style={{ fontSize: window.innerWidth === 280 || window.innerWidth === 320 ? "17.5px" : " ", }}>For the purposes of the legal and Regulatory review, the following laws have been reviewed:</p>
                            <br />

                            {
                                para?.map(({ text }, id) => {
                                    return <p id={id} className={window.innerWidth <= 540 ? "mobileparaforfeedback mb-0" : "feedbackpara col-8"} style={{ fontSize: window.innerWidth === 280 || window.innerWidth === 320 ? "17.5px" : " ", paddingLeft: window.innerWidth < 500 ? 0 : 80, }}>{`${id + 1} ) ${text}`}</p>
                                })
                            }
                        </div>
                    </div>
