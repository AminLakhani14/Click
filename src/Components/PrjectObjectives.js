                ...
                >
                    ...
                    >
                        <div className="" >
                            ...
                            <p className={window.innerWidth <= 540 ? "mobileparaforfeedback mb-0" : "feedbackpara col-8"} style={{ fontSize: window.innerWidth === 280 || window.innerWidth === 320 ? "17.5px" : " ", textAlign: "center", }}>To improve urban management, service delivery and the business environment in Karachi.
                            ...
                            <p className={window.innerWidth <= 540 ? "mobileparaforfeedback mb-0" : "feedbackpara col-8"} style={{ fontSize: window.innerWidth === 280 || window.innerWidth === 320 ? "17.5px" : " ",  textAlign: "center" }}>Recruitment of IT firm for the operationalization of the Sindh Business One Stop Shop( S-BOSS) </p>
                            <p className={window.innerWidth <= 540 ? "mobileparaforfeedback mb-0" : "feedbackpara col-8"} style={{ fontSize: window.innerWidth === 280 || window.innerWidth === 320 ? "17.5px" : " ",  textAlign: "center" }}>Following Laws have been reviewed and draft legal changes/updates are underway. </p>
                            <p className={window.innerWidth <= 540 ? "mobileparaforfeedback mb-0" : "feedbackpara col-8"} style={{ fontSize: window.innerWidth === 280 || window.innerWidth === 320 ? "17.5px" : " ",  textAlign: "center" }}>For the purposes of the legal and Regulatory review, the following laws have been reviewed:</p>
                            <br />
