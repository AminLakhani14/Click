...
const para=[
 ...
 <br/>
                            <p className={window.innerWidth <= 540 ? "mobileparaforfeedback mb-0" : "feedbackpara col-8"} style={{ fontSize: window.innerWidth === 280 || window.innerWidth === 320 ? "17.5px" : " ", fontWeight: "bold" }}>(A) MAPPING OF BUSINESS REGISTRATION PROCEDURES:  </p>
                            <p className={window.innerWidth <= 540 ? "mobileparaforfeedback mb-0" : "feedbackpara col-8"} style={{ fontSize: window.innerWidth === 280 || window.innerWidth === 320 ? "17.5px" : " ", paddingLeft: 40 }}>Existing and proposed design (Sindh Business One Stop Shop) of 132+ Registrations,
                            ...
                            <p className={window.innerWidth <= 540 ? "mobileparaforfeedback mb-0" : "feedbackpara col-8"} style={{ fontSize: window.innerWidth === 280 || window.innerWidth === 320 ? "17.5px" : " ", fontWeight: "bold" }}> WAY FORWARD:</p>
                            <br/>
                               <div className='ps-5'>
                               <p className={window.innerWidth <= 540 ? "mobileparaforfeedback mb-0" : "feedbackpara col-8"} style={{ fontSize: window.innerWidth === 280 || window.innerWidth === 320 ? "17.5px" : " ", fontWeight: "bold" }}> (A) ESTABLISHING SINDH BUSINESS ONE STOP SHOP (S-BOSS)  </p>
