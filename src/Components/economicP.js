...
import "../Css/cursorpoint.css";

function EconomicPowerhouse(props) {
  ...
  return (
    <>
        ...
        >
          ...
          >
            <h4 
              style={{ display: "contents", color: "black", fontSize: "30px" }}
            > 
              <div className="pointer-cursor" style={{display:'inline'}} >
              Why Sindh {value}
              </div>
            </h4>
          </Link>
      ...
      >
        ...
        >
          {" "}
          Contact Our Economic PowerHouse Expert
        </label>
        <div
          className="col-lg-12 "
          style={{
...
export default EconomicPowerhouse;
